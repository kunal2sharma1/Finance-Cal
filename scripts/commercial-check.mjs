...
if (!placement.includes('affiliate-slot')) failures.push('Commercial placement component must declare an affiliate placement slot.')

const disclosure = await readFile('src/components/CommercialDisclosure.jsx', 'utf8')
if (!disclosure.toLowerCase().includes('affiliate')) failures.push('Commercial disclosure must explain affiliate relationships.')
