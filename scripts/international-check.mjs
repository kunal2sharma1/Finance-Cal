...
const expectedCountryCalculators = {
  US: ['401k', 'roth-ira', 'hsa', 'us-mortgage'],
  GB: ['uk-isa', 'uk-pension', 'uk-lifetime-isa', 'uk-mortgage'],
  CA: ['canada-tfsa', 'canada-rrsp', 'canada-fhsa', 'canada-mortgage'],
  AU: ['australia-super', 'australia-concessional-super', 'australia-mortgage'],
