...
Status: **IN PROGRESS — implementation branch initialized**

Baseline: created from `main` before new generation work.
...
- [ ] Phases 4–9 calculator contract hardening implemented.
